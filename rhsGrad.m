function out = rhsGrad(x, u)
% wyliczanie prawej strony rownan w postaci kanonicznej z gradientem
global mu restmu C1
...
% dH/du
out(11) = x(8) * cos(u(2)) / x(5) + x(9) * sin(u(2)) / x(5) - x(10) * C1;
out(12) = - x(8) * u(1) * sin(u(2)) / x(5) + x(9) * u(1) * cos(u(2)) / x(5);
end